...
After installation one can import package in the standard R way and call it's functions. In this case gipsqda() is used to build a classifier on widely known \textit{Iris} dataset.
