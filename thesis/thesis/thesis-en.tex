...
\textcolor{red}{Sekcja do Napisania od nowa na podstawie wszystkich nowych eksperymentów, jak jest niezle to trzeba przynajmniej minimalnie zmienic}
...
\label{ch:conclusion}
\textcolor{red}{Trzeba to skorygowac na podstawie tego co sie zmienilo w eksperymentach}
