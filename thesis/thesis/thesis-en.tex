...
We attach full derivation of \eqref{gipsmultposteriorformula} in the \autoref{app:gipsmult_derivation}.
...
\end{tikzpicture}
\caption{The diagram illustrates the hierarchical relationships between the models. It clearly shows that \texttt{gipsLDA} is contained within \texttt{gipsmultQDA}, while simultaneously being a specific case of \texttt{LDA}. All models are subsets of the general \texttt{QDA}.}
