...
\begin{itemize}
    ...
    \item \textbf{Optimized Optimization:} For $p \ge 10$, the current Metropolis–Hastings sampler with transposition-based proposals mix slowly. Future work  may include exploring more efficient discrete optimization/sampling methods that can outperform vanilla MH, e.g., other proposals distributions, simulated annealing, or evolutionary algorithms.
\end{itemize}
% ======================================================================
%                          Rest
% ======================================================================
