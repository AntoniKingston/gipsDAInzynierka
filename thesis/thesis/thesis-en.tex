...
It should be also noted that all covariance estimates are passed to regularizing function after being projected. The exact procedure is discussed in \autoref{sec:baseline_regularization}.
