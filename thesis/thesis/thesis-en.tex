...
\begin{enumerate}
    ...
    To rigorously stress-test the models under varied spectral conditions, we employ a method based on spectral decomposition rather than the standard Wishart distribution. This allows for direct control over the eigenvalues and the condition number of the matrix. The procedure is as follows:
    \begin{itemize}
...
\textcolor{red}{W tej sekcji trzeba mocno cytowania dodac i chyba te jawne pisanie linkow nie przejdzie}
...
\begin{itemize}
    ...
    \item \textbf{Source:} \url{https://www.kaggle.com/datasets/fedesoriano/heart-failure-prediction}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Source:} \url{https://archive.ics.uci.edu/dataset/17/breast-cancer-wisconsin-diagnostic}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Source:} \url{https://www.kaggle.com/datasets/birdy654/eeg-brainwave-dataset-feeling-emotions}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Source:} \url{https://archive.ics.uci.edu/dataset/198/steel-plates-faults}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Source:} \url{https://archive.ics.uci.edu/dataset/325/sensorless+drive+diagnosis}
\end{itemize}
...
Let $N_{\min}$ be the lower bound (parameter \texttt{lb}, typically set to 16) and $N_{\max}$ be the maximum available sample size. The sequence of sample sizes is generated as follows:
