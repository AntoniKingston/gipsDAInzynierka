...
\textbf{Configuration:} $p=10$, $k=10$, Distribution: Chi-squared, MAP: \texttt{FALSE}, Main Permutation: Dense.
...
\textbf{Configuration:} $p=10$, $k=2$, Distribution: Chi-squared, MAP: \texttt{FALSE}, Main Permutation: Dense.
...
\textbf{Configuration:} $p=5$, $k=2$, Distribution: Chi-squared, MAP: \texttt{False}, Main Permutation: Dense.
...
\textbf{Configuration:} $p=5$, $k=5$, Distribution: Exponential, MAP: \texttt{False}, Main Permutation: Sparse.
