...
\begin{frame}{R Package Structure}
    ...
    \begin{itemize}
        ...
        \item \textbf{Tests:} Comprehensive suite using the \texttt{testthat} framework, achieving approximately 85\% code coverage.
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Workflow, Documentation and CRAN}
    \begin{itemize}
        \item Github actions were configured to run unit tests and generate online documentation automatically upon push.
        \item Documentation is available online at \href{https://antonikingston.github.io/gipsDA/}{https://antonikingston.github.io/gipsDA/}.
    \end{itemize}\\
    The package is available at CRAN, it can be installed with:
...
\begin{frame}{Synthetic Data Results}
    ...
    \begin{itemize}
        \item \textbf{Regularization Benefit:} In data-scarce regimes ($n$ small), \texttt{gipsMultQDA} outperformed standard \texttt{QDA}.
...
\begin{frame}{Synthetic Data Results}
    ...
    \includegraphics[width = 0.7\linewidth]{seminarium_png/synth_10_10_chisq_dense_trans_TRUE.png}
    %\caption*{Testing results synth\_10\_10\_chisq\_dense\_trans\_TRUE scenario}
    \end{figure}
\end{frame}
...
\begin{frame}{Real-World Data Performance}
    \begin{itemize}
        ...
        \item \textbf{Breast Cancer (Diagnostic):} \texttt{gipsLDA classic} achieved robust performance with as few as 30 observations.
...
\begin{frame}{Real-World Data Performance}
    ...
    \includegraphics[width = 0.7\linewidth]{seminarium_png/breast_boxplot}
...
\begin{frame}{Real-World Data Performance}
    ...
    \includegraphics[width = 0.85\linewidth]{seminarium_png/heart_plot_auc}
...
\begin{frame}{Opportunities for Further Development}
    \begin{itemize}
        ...
        \item \textbf{Conditional Independence:} Integrating graphical modeling to simultaneously discover symmetries and sparsity, utilizing the theory of Colored Graphical Gaussian Models~\cite{chojecki2026newclasscoloredgaussian}.
        \item \textbf{Scalability \& Optimization:} Rewriting computational bottlenecks using \texttt{Rcpp} and exploring advanced sampling algorithms (e.g. evolutionary algorithms) to improve performance in high dimensions.
    \end{itemize}
\end{frame}
