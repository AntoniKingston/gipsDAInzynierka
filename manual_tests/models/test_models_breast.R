...
breast_exp_data <- generate_single_plot_info_real_data(
  df, granularity = 16, lb = 20, up=150, n_experiments = 30, n_experiments_spe = 100, spe_idx = spe_idx,
...
ggsave("data/real_world_datasets/breast_plot_auc.png",
       plot = plot_object_auc, width = 10, height = 5, dpi = 300)
ggsave("data/real_world_datasets/breast_boxplot.png",
